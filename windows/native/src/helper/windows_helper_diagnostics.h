...
enum class WindowsHelperEvent : std::size_t {
  ...
  kProtectedAuthorizationFailure,
  kProtectedRequestValidationFailure,
  kProtectedTargetAuthorityFailure,
  kProtectedStageAuthorizationFailure,
  kProtectedPayloadPreparationFailure,
  kProtectedTransactionConstructionFailure,
  kProtectedPreparationFailure,
  kProtectedJournalValidationFailure,
  kProtectedArtifactVerificationFailure,
  kProtectedEndpointBindingFailure,
  kProtectedRecoveryStorageFailure,
  kProtectedRecoveryHostFailure,
  kProtectedActivationFailure,
  kCount,
};
