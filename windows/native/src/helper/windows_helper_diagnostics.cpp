...
constexpr std::array<WindowsHelperEventDescriptor,
    ...
    kWindowsHelperEvents = {{
        ...
        {1047, EVENTLOG_ERROR_TYPE, "protected authorization failure",
         L"protected authorization failure"},
        {1048, EVENTLOG_ERROR_TYPE, "protected request validation failure",
         L"protected request validation failure"},
        {1049, EVENTLOG_ERROR_TYPE, "protected target authority failure",
         L"protected target authority failure"},
        {1050, EVENTLOG_ERROR_TYPE, "protected stage authorization failure",
         L"protected stage authorization failure"},
        {1051, EVENTLOG_ERROR_TYPE, "protected payload preparation failure",
         L"protected payload preparation failure"},
        {1052, EVENTLOG_ERROR_TYPE,
         "protected transaction construction failure",
         L"protected transaction construction failure"},
        {1053, EVENTLOG_ERROR_TYPE, "protected preparation failure",
         L"protected preparation failure"},
        {1054, EVENTLOG_ERROR_TYPE, "protected journal validation failure",
         L"protected journal validation failure"},
        {1055, EVENTLOG_ERROR_TYPE,
         "protected artifact verification failure",
         L"protected artifact verification failure"},
        {1056, EVENTLOG_ERROR_TYPE, "protected endpoint binding failure",
         L"protected endpoint binding failure"},
        {1057, EVENTLOG_ERROR_TYPE, "protected recovery storage failure",
         L"protected recovery storage failure"},
        {1058, EVENTLOG_ERROR_TYPE, "protected recovery host failure",
         L"protected recovery host failure"},
        {1059, EVENTLOG_ERROR_TYPE, "protected activation failure",
         L"protected activation failure"},
    }};
