...
/// Builds the parser shared by the package entrypoints.
ArgParser buildPackageParser() {
  return ArgParser()
...
/// Runs the package command shared by the standalone and legacy entrypoints.
Future<int> runPackageCommand(
  List<String> args, {
  StringSink? output,
}) async {
  final out = output ?? stdout;
  final parser = buildPackageParser();
