...
| Migration guidance | [`migration/1.x-to-2.0.md`](migration/1.x-to-2.0.md), [`migration/2.x-to-3.0.md`](migration/2.x-to-3.0.md), and [`migration/3.0-to-3.1.md`](migration/3.0-to-3.1.md) | Compatibility or upgrade behavior changes |
